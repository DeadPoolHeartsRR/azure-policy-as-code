...
param customPolicyID string //Advanced
    ...
    policyDefinitions: [
      {
        ...
        policyDefinitionReferenceId: 'Allowed locations for resource groups' //Advanced
        parameters: {
          listOfAllowedLocations: {
      ...
      }
      {
        ...
        policyDefinitionReferenceId: 'Allowed locations' //Advanced
        parameters: {
          listOfAllowedLocations: {
            value: '[parameters(\'listOfAllowedLocations\')]'
          }
      ...
      }
      {
        ...
        policyDefinitionReferenceId: 'Allowed virtual machine size SKUs' //Advanced
        parameters: {
          listOfAllowedSKUs: {
      ...
      }
      {
        ...
        policyDefinitionReferenceId: 'Audit virtual machines without disaster recovery configured' //Advanced
        parameters: {}
      }
    ]
  }
    ...
    policyDefinitions: [
      {
        ...
        policyDefinitionId: customPolicyID //Advanced
        policyDefinitionReferenceId: 'Add tag to resource group' //Advanced
        parameters: {
          tagName: {
